module.exports = {
  ...
  testEnvironment: 'jsdom' // indica em que ambiente os test estao executando, para saber como jest vai se comportar na hora o html, o que ele precisa pra simular nossa aplicação
}
